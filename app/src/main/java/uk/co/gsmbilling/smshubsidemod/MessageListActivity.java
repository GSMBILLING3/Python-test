...
public class MessageListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_message_list);
        ...
        messagelistAdapter = new MessagelistAdapter(new ArrayList<Message>(), this);
        ...
        if (swipeRefreshLayoutContainer != null) {
            swipeRefreshLayoutContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ParseUtility.getThreads(messagelistAdapter);
            ...
            new AlertDialog.Builder(MessageListActivity.this)
                    .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ParseUtility.logout();
                            Toast.makeText(MessageListActivity.this, R.string.logged_out, Toast.LENGTH_SHORT).show();
